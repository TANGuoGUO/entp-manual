...
flet-quill-editor [Flet](https://flet.dev) extension.

Flet bridge for Flutter Quill rich text editing
...
Add `flet-quill-editor` dependency to the `pyproject.toml` of your Flet project:

* **From Git**

```toml
dependencies = [
  "flet-quill-editor @ git+https://github.com/MY_GITHUB_ACCOUNT/flet-quill-editor",
  "flet>=0.86.5",
]
```
...
Detailed documentation for this package can be found [here](https://MY_GITHUB_ACCOUNT.github.io/flet-quill-editor/).
